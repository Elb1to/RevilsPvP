package eu.revils.revilspvp.kt.command.bukkit

import eu.revils.revilspvp.RevilsPvP
import eu.revils.revilspvp.kt.command.CommandCompat
import eu.revils.revilspvp.kt.command.CommandNode
import eu.revils.revilspvp.kt.command.data.argument.ArgumentProcessor
    ...
    fun tabComplete(sender: CommandSender, cmdLine: String): List<String> {
        ...
        if (rawArgs.isEmpty()) {
            ...
            try {
                ...
                val parameterType: ParameterType<*>? = RevilsPvP.getInstance().commandHandler.getParameterType(data.type)
