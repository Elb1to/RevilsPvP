package eu.revils.revilspvp.kt.util.serialization
...
object PlayerInventorySerializer {
    ...
    fun serialize(player: Player): String {
        return RevilsPvP.plainGson.toJson(PlayerInventoryWrapper(player) as Any)
    }

    @JvmStatic
    fun deserialize(json: String): PlayerInventoryWrapper {
        return RevilsPvP.plainGson.fromJson(json, PlayerInventoryWrapper::class.java)
    }
