...
import eu.revils.revilspvp.queue.listener.QueueGeneralListener;
import eu.revils.revilspvp.queue.listener.QueueItemListener;
...
public final class QueueHandler {
    ...
    public QueueHandler() {
        Bukkit.getPluginManager().registerEvents(new QueueGeneralListener(this), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new QueueItemListener(this), RevilsPvP.getInstance());
