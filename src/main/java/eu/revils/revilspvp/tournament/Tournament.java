...
public class Tournament {
    ...
    public void check() {
        ...
        if (activeParties.isEmpty()) {
            if (lost.isEmpty()) {
                ...
                RevilsPvP.getInstance().getTournamentHandler().setTournament(null);
                return;
            }
    ...
    private void repeatMessage(String message, int times, int interval) {
        ...
        }.runTaskTimer(RevilsPvP.getInstance(), 0, interval * 20);
    }
    ...
    private void startRound() {
        ...
        while (1 < oldPartyList.size()) {
            ...
            matches.add(RevilsPvP.getInstance().getMatchHandler().startMatch(ImmutableList.of(new MatchTeam(firstParty.getMembers()), new MatchTeam(secondParty.getMembers())), type, false, false));
        }
