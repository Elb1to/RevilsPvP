...
import eu.revils.revilspvp.kt.util.Cuboid;
...
import eu.revils.revilspvp.util.AngleUtils;

/**
 * Represents a pasted instance of an {@link ArenaSchematic}.
 * See {@link eu.revils.revilspvp.arena} for a comparision of
