package eu.revils.revilspvp.arena.menu.select;
...
import eu.revils.revilspvp.kittype.menu.select.SendDuelButton;
import eu.revils.revilspvp.kittype.menu.select.ToggleAllButton;
...
public class SelectArenaMenu extends Menu {
    ...
    public SelectArenaMenu(KitType kitType, Callback<Set<String>> mapsCallback, String title) {
        ...
        for (ArenaSchematic schematic : RevilsPvP.getInstance().getArenaHandler().getSchematics()) {
