...
import eu.revils.revilspvp.duel.listener.DuelListener;
...
public final class DuelHandler {
    ...
    public DuelHandler() {
        Bukkit.getPluginManager().registerEvents(new DuelListener(), RevilsPvP.getInstance());
        Bukkit.getScheduler().runTaskTimerAsynchronously(RevilsPvP.getInstance(), () -> activeInvites.removeIf(DuelInvite::isExpired), 20, 20);
    }
