package eu.revils.revilspvp.postmatchinv;
...
public final class PostMatchInvLang {
    ...
    private static TextComponent clickToViewLine(UUID member) {
        String memberName = RevilsPvP.getInstance().getUuidCache().name(member);
        TextComponent component = new TextComponent();

        component.setText(memberName);
        component.setColor(ChatColor.YELLOW);
        component.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(ChatColor.GREEN + "Click to view inventory of " + ChatColor.AQUA + memberName).create()));
