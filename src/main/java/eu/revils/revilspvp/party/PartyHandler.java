...
import eu.revils.revilspvp.party.listener.PartyChatListener;
import eu.revils.revilspvp.party.listener.PartyItemListener;
import eu.revils.revilspvp.party.listener.PartyLeaveListener;
...
public final class PartyHandler {
    ...
    public PartyHandler() {
        Bukkit.getPluginManager().registerEvents(new PartyChatListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new PartyItemListener(this), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new PartyLeaveListener(), RevilsPvP.getInstance());
    }
