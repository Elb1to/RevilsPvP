...
public final class MatchHandler {
    ...
    public MatchHandler() {
        Bukkit.getPluginManager().registerEvents(new GoldenHeadListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new KitSelectionListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchBlockPickupListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchBuildListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchComboListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchCountdownListener(), RevilsPvP.getInstance());
        ...
        Bukkit.getPluginManager().registerEvents(new MatchHealthDisplayListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchPartySpectateListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchRodListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchSoupListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchStatsListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new MatchWizardListener(), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new SpectatorItemListener(this), RevilsPvP.getInstance());
        Bukkit.getPluginManager().registerEvents(new SpectatorPreventionListener(), RevilsPvP.getInstance());
    }
    ...
    public Match startMatch(List<MatchTeam> teams, KitType kitType, boolean ranked, boolean allowRematches) {
        ...
        for (MatchTeam team : teams) {
            for (UUID member : team.getAllMembers()) {
                ...
                if (isPlayingOrSpectatingMatch(memberPlayer)) {
                    throw new IllegalArgumentException(RevilsPvP.getInstance().getUuidCache().name(member) + " is already in a match!");
                }
            }
        }
        ...
        if (!openArenaOpt.isPresent()) {
            RevilsPvP.getInstance().getLogger().warning("Failed to start match: No open arenas found");
            return null;
        }
