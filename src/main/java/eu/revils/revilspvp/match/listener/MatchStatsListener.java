...
public class MatchStatsListener implements Listener {
    ...
    public void onDamage(EntityDamageByEntityEvent event) {
        ...
        Match damagerMatch = RevilsPvP.getInstance().getMatchHandler().getMatchPlaying(damager);
    ...
    public void onMatchEnd(MatchEndEvent event) {
        ...
        match.getTeams().forEach(team -> {
            if (match.getWinner() == team) {
                team.getAllMembers().forEach(RevilsPvP.getInstance().getWinsMap()::incrementWins);
            } else {
                team.getAllMembers().forEach(RevilsPvP.getInstance().getLossMap()::incrementLosses);
            }
        });
    }
    */
