...
public final class EditKitMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        // The vertical row
        for (int i = 0; i <= 5; i++) {
            buttons.put(getSlot(1, i), Button.placeholder(Material.STAINED_GLASS_PANE, (byte) 15));
        }

        // The horizontal row
        for (int i = 0; i <= 8; i++) {
            buttons.put(getSlot(i, 1), Button.placeholder(Material.STAINED_GLASS_PANE, (byte) 15));
        }
        ...
        buttons.put(getSlot(4, 0), Button.placeholder(Material.STAINED_GLASS_PANE, (byte) 15));
