package eu.revils.revilspvp.morpheus.menu.parameter;
        ...
        toReturn.put(8, new Button() { // todo change although i doubt one event would ever have more than 8 parameters lol
            ...
            public void clicked(Player player, int slot, ClickType clickType, InventoryView view) {
                ...
                if (GameQueue.INSTANCE.size() > 9) {
                    ...
                    player.sendMessage(ChatColor.YELLOW + "You've added a " + ChatColor.AQUA + event.getName().toLowerCase() + ChatColor.YELLOW + " event to the queue.");
                }
