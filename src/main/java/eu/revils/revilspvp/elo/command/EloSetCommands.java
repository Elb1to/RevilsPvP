package eu.revils.revilspvp.elo.command;
...
public final class EloSetCommands {
    ...
    public static void eloSetTeam(Player sender, @Param(name="target") Player target, @Param(name="kit type") KitType kitType, @Param(name="new elo") int newElo) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "Set " + kitType.getDisplayName() + " elo of " + RevilsPvP.getInstance().getUuidCache().name(targetParty.getLeader()) + "'s party to " + newElo + ".");
    }
