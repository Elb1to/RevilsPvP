package eu.revils.revilspvp.statistics;
...
public class StatisticsHandler implements Listener {
    ...
    public StatisticsHandler() {
        ...
        Bukkit.getScheduler().runTaskTimerAsynchronously(RevilsPvP.getInstance(), () -> {
    ...
    public void onDeath(PlayerDeathEvent event) {
        ...
        Match diedMatch = RevilsPvP.getInstance().getMatchHandler().getMatchPlayingOrSpectating(died);
    ...
    public void loadStatistics(UUID uuid) {
        ...
        document.put("lastUsername", RevilsPvP.getInstance().getUuidCache().name(uuid));
    ...
    public void saveStatistics(UUID uuid) {
        ...
        toInsert.put("lastUsername", RevilsPvP.getInstance().getUuidCache().name(uuid));
